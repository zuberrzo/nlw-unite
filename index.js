...
const atualizainformacao = (participantes) => {
  let output = ""
  //estrutura repeticao
  ...
  // substituir informacao HTML
  document.querySelector('tbody').innerHTML = output
}
atualizainformacao(participantes)
...
const fazerCheckIn = (event) => {
  ...
  const menssagemConfirmacao = 'Tem certeza que deseja fazer o Checkin?' // true or false
